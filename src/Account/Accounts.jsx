      ...
      if (response.ok) {
        ...
        if (data.user.email !== changeData.email) {
          const responsesendtoken = await fetch(
            "https://virtual-crypto-stock-market-backend.vercel.app/api/sendverificationemail",
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
        ...
        if (data.user.name !== changeData.name) {
          const updateuser = await fetch(
            "https://virtual-crypto-stock-market-backend.vercel.app/api/updateuser",
            {
              method: "PUT",
              headers: {
                "Content-Type": "application/json",
    ...
    try {
      ...
      if (response.ok) {
        const verifytoken = await fetch(
          "https://virtual-crypto-stock-market-backend.vercel.app/api/verifyemail",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
