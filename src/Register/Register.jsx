...
function Register() {
  ...
  const handleSignupSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://virtual-crypto-stock-market-backend.vercel.app/api/checkemail",
        {
          method: "POST",
          headers: {
  ...
  const handleotp = async (e) => {
    ...
    const response = await fetch(
      "https://virtual-crypto-stock-market-backend.vercel.app/api/crosscheckemail",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
    ...
    if (response.ok) {
      ...
      const responsecreate = await fetch(
        "https://virtual-crypto-stock-market-backend.vercel.app/api/createuser",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
