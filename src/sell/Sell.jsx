...
export default function Sell() {
    ...
    try {
      ...
      if (selectedcrypto) {
        const response = await fetch(
          `https://virtual-crypto-stock-market-backend.vercel.app/api/single-crypto?coin=${selectedcrypto.coin}`,
          {
            credentials: "include",
          }
        );
        ...
        if (response.ok) {
          ...
          if (selectedCoinData) {
            ...
            const responsecash = await fetch(
              "https://virtual-crypto-stock-market-backend.vercel.app/api/portfolio",
              {
                method: "GET",
                headers: {
            ...
            const responsecryptoquantity = await fetch(
              "https://virtual-crypto-stock-market-backend.vercel.app/api/dashboard",
              {
                credentials: "include",
              }
            );
  ...
  const handleSelling = async () => {
    try {
      ...
      setIsLoading(true);
      const response = await fetch(
        "https://virtual-crypto-stock-market-backend.vercel.app/api/sell",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
